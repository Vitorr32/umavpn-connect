...
- `https://api.games.umamusume.jp/` — Global post-connect geo verification
- `https://api-umamusume.cygames.jp/` — Japanese post-connect geo verification (`GameConnectivityChecker.kt`)
